...
from ..models import CcaSsg
from absl import flags

FLAGS = flags.FLAGS
log = logging.getLogger(__name__)

def perform_cca_ssg_training(data, output_dir, device, input_size: int, has_features: bool, g_zoo, **kwargs):
    ...
    for epoch in tqdm(range(1, FLAGS.epochs + 1), desc="CCA-SSG Training"):
        model.train()
        optimizer.zero_grad()
